...
(Rent 1 Book at a Time) 
  ...
  <button type='submit' name='pay' style='border-radius:5px;background:blue;width:118px;height:30px;border:none;cursor:pointer;color:white' id='#pay'>Proceed</button>
</div>
...
<?php
    ...
    ?>
    <tr>
    <td style="color: red;">This book not available at this moment!</td></tr>
    <?php
      }
    ?>
  </tbody>
