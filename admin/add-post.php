...
<div class="addpost">
    ...
    <form  action="save-post.php" method="POST" enctype="multipart/form-data">
        ...
        <!-- Add Book Quantity Input Field -->
        <div> <label for="book-quantity">Quantity</label></div>
        <input style="width:80%; height:35px" type="number" name="prod-quantity"  value="" required />
